    ...
    public static class StreamerBotEventRegistry
    {
        public static readonly Dictionary<(string Category, string Name), Type> EventTypes =
            new()
            {
                ...
                { ("Twitch", "Sub"), typeof(TwitchSubscriptionEvent) },
                { ("Twitch", "ReSub"), typeof(TwitchSubscriptionEvent) },
                { ("Twitch", "GiftSub"), typeof(TwitchGiftSubEvent) },
                { ("Twitch", "GiftBomb"), typeof(TwitchGiftSubEvent) },
                { ("Twitch", "RewardRedemption"), typeof(TwitchRedemptionEvent) },
                { ("Twitch", "RewardRedemptionUpdated"), typeof(TwitchRedemptionEvent) },
                { ("Twitch", "Whisper"), typeof(TwitchWhisperEvent) },
                { ("Twitch", "PredictionCreated"), typeof(TwitchPredictionStartedEvent) },
                ...
                { ("Obs", "StreamingStarted"), typeof(ObsStreamStartedEvent) },
                { ("Obs", "StreamingStopped"), typeof(ObsStreamStoppedEvent) },
                ...
                // YouTube Events
                // ----------------------------------------------------
                { ("YouTube", "Message"), typeof(YouTubeChatMessageEvent) },
                { ("YouTube", "FirstWords"), typeof(YouTubeFirstWordsEvent) },
                { ("YouTube", "NewSponsor"), typeof(YouTubeMemberJoinEvent) },
                ...
                { ("Kick", "Resubscription"), typeof(KickSubscriptionEvent) },
                { ("Kick", "GiftSubscription"), typeof(KickGiftSubEvent) },
                { ("Kick", "MassGiftSubscription"), typeof(KickGiftSubEvent) },
